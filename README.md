...
Dashboard interaktif dapat diakses melalui Streamlit Cloud:

https://ecommerce-public-dashboard-aldomp7.streamlit.app/

Dashboard ini menyajikan ringkasan performa e-commerce berdasarkan revenue, jumlah pesanan, review pelanggan, durasi pengiriman, status keterlambatan, serta segmentasi pelanggan menggunakan RFM Analysis.
